...
@Component({
  selector: "app-chill-the-lion",
  templateUrl: "./chill-the-lion.component.html",
  styleUrls: ["./chill-the-lion.component.css"]
})
export class ChillTheLionComponent implements OnInit {
  constructor() {}
